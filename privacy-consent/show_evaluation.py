...
def show_evaluation():
         ...
         print(f"Std.: {prescription_info[3]} kb ({prescription_info[3]/1024} MB)")    
         ...
         print(f"Min.: {personal_id_info[2]} kb ({personal_id_info[2]/1024} MB)")  
         print(f"Std.: {personal_id_info[3]} kb ({personal_id_info[3]/1024} MB)") 
         ...
         print(f"Std.: {medication_info[3]} kb ({medication_info[3]/1024} MB)") 
         ...
         print(f"Std.: {diagnosis_info[3]} kb ({diagnosis_info[3]/1024} MB)")  
         ...
         print(f"Std.: {memory_evaluation_personal_ID[3] } kb") 
         ...
         print(f"Std.: {memory_evaluation_medication[3] } kb")
         ...
         print(f"Std.: {memory_evaluation_diagnosis[3] } kb")
         ...
         print(f"Std.: {execution_time_personal_ID[3] } ms") 
         ...
         print(f"Std.: {execution_time_medication[3] } ms")     
         ...
         print(f"Std.: {execution_time_diagnosis[3] } ms")   
