...
//as soon as the instance is performed
...
pub fn handle<S: Storage, A: Api, Q: Querier>(
    ...
    match msg {
        //two main operations: validate the transaction and send the contract tokens to the patient or refund
        //for testing, we send just one contract token to the patient for each valid transaction
...
// tries to validate the transaction / prescription
// For the model, basically:
// - only transactions carried out by the doctor will be valid
...
fn try_approve<S: Storage, A: Api, Q: Querier>(
    ...
    // stores the amount of tokens to be sent
...
// moves contract tokens to the patient
fn send_tokens(
