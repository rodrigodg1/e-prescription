 ...
 */
exports.getProofs = async (options) => {
    ...
    if (!skipProofCompaction) {
        ...
        document = await jsonld_1.default.compact(document, jsonld_signatures_1.SECURITY_CONTEXT_URL, {
            documentLoader,
            expansionMap,
    ...
    proofs = proofs.map((matchedProof) => (Object.assign({ "@context": jsonld_signatures_1.SECURITY_CONTEXT_URL }, matchedProof)));
    return {
        proofs,
        document
    };
 ...
 */
exports.getTypeInfo = async (document, options) => {
    ...
    toExpand["@type"] = jsonld_1.default
        .getValues(document, "@type")
        .concat(jsonld_1.default.getValues(document, alias));
