...
function _expandObject2() {
  _expandObject2 = _asyncToGenerator(function* ({
    activeCtx,
    activeProperty,
    expandedActiveProperty,
    element,
    ...
    for (const key of keys) {
      ...
      if (expandedProperty === '@included' && _processingMode(activeCtx, 1.1)) {
        const includedResult = _asArray((yield api.expand({
          activeCtx,
          activeProperty,
          element: value,
          options,
      ...
      if (expandedProperty === '@reverse') {
        ...
        expandedValue = yield api.expand({
          activeCtx,
      ...
      if (container.includes('@language') && _isObject(value)) {
        ...
        expandedValue = yield _expandIndexMap({
          activeCtx: termCtx,
          options,
          activeProperty: key,
          value,
...
function _expandIndexMap2() {
  _expandIndexMap2 = _asyncToGenerator(function* ({
    activeCtx,
    options,
    activeProperty,
    value,
